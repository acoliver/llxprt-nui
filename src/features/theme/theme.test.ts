...
describe("ThemeColors message properties", () => {
  ...
  it("should accept optional message.groupSpacing property", () => {
    ...
    const groupSpacing = (mockTheme.colors.message as ThemeColors["message"] & { groupSpacing?: number }).groupSpacing;
    // Either undefined or a number is valid
    expect(groupSpacing === undefined || typeof groupSpacing === "number").toBe(true);
  });
});
