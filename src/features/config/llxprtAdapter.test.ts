...
describe("transformStream", () => {
  it("should yield transformed events from async iterable", async () => {
    const mockEvents: ServerGeminiStreamEvent[] = [
      { type: GeminiEventType.Content, value: "Hello" } as ServerGeminiStreamEvent,
      { type: GeminiEventType.Content, value: " world" } as ServerGeminiStreamEvent,
      { type: GeminiEventType.Finished, value: { reason: FinishReason.STOP } } as ServerGeminiStreamEvent
    ];
  ...
  it("should handle empty stream", async () => {
    const createEmptyStream = (events: ServerGeminiStreamEvent[]): AsyncGenerator<ServerGeminiStreamEvent> => {
