import { Logger, MessageSenderType, Storage } from "@vybestack/llxprt-code-core";
 ...
 */
export function createPersistentHistory(workingDir: string, sessionId: string): PersistentHistoryService {
